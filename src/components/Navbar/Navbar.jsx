...
const Navbar = ({ userId, userRole, userName, userProfilePicture }) => {
      ...
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className={`lg:flex lg:items-center lg:space-x-6 absolute lg:static bg-gradient-to-r from-blue-700 to-purple-700 w-full lg:w-auto top-[60px] left-0 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? "block shadow-lg py-4" : "hidden"}`}>
          ...
          {!userId ? (
            ...
            <>
              <Link to="/assets" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">📦 My Assets</Link>
              <Link to="/team" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">👥 My Team</Link>
              <Link to="/request-asset" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">🔧 Request for Asset</Link>
              <Link to="/profile" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">👤 Profile</Link>
            </>
          ) : userRole === 'hr-manager' && paymentStatus ? (
            <>
              <Link to="/asset-list" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">📋 Asset List</Link>
              <Link to="/add-asset" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">➕ Add New Asset</Link>
              <Link to="/all-requests" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">📜 All Requests</Link>
              <Link to="/employee-list" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">👨‍💼 Employee List</Link>
              <Link to="/add-employee" className="block px-4 py-2 lg:px-0 hover:bg-purple-500 rounded">➕ Add New Employee</Link>
            </>
          ) : userRole === 'hr-manager' && !paymentStatus ? (
